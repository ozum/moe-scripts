...
const jestConfig = {
  ...
  coveragePathIgnorePatterns: [...ignores, `${dir}/(umd|cjs|esm)-entry.js$`, `/${dir}/bin/`], // Exclude CLI files located in bin, because cli cannot be instrumented by JEST as of 22
